        ...
        <section className='bg-white '>
            <div className='container flex items-center min-h-screen px-6 py-12 mx-auto'>
                <div className='flex flex-col items-center max-w-sm mx-auto text-center'>
                    ...
                    <p className='mt-4 text-gray-500 '>Your Url: {location.pathname.split("/")[1]} invalid</p>
                    ...
                    <div className='flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto'>
                        ...
                        >
                            <svg
                                ...
                                strokeWidth='1.5'
                                stroke='currentColor'
                                className='w-5 h-5 rtl:rotate-180 text-blue-700'
                            >
                                <path
                                    strokeLinecap='round'
                                    strokeLinejoin='round'
                        ...
                        <button className="btn btn-outline btn-success btn-sm" label={'Home'} onClick={() => navigate('/')}>Home</button>
                    </div>
                </div>
            </div>
        </section>
